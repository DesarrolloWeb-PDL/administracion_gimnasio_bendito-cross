        ...
        <table className="min-w-full text-left text-sm">
          <thead className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
            <tr>
              ...
              <th className="px-6 py-3 text-right font-semibold">💰 Ingreso</th>
            </tr>
          </thead>
            ...
            {loading ? (
              ...
              ingresos.map((item) => (
                <tbody key={item.dia}>
                  ...
                  >
                    <td className={`px-6 py-4 font-semibold text-base transition-colors duration-200 ${
                      diaSeleccionado === item.dia
                    ...
                    <td className={`px-6 py-4 text-right font-bold text-lg transition-colors duration-200 ${
                      diaSeleccionado === item.dia
