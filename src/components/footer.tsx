    ...
    <footer className="w-full border-t border-zinc-800 bg-black py-6">
      <div className="flex flex-col items-center gap-3 px-4">
        <div className="flex items-center gap-4 text-zinc-400 text-sm">
          <a
            href="https://www.instagram.com/benditocross/"
            target="_blank"
          ...
          <a
            href="https://www.facebook.com/benditocross"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-white transition-colors"
          >
          ...
          <a
            href="https://wa.me/5493772408715"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-white transition-colors"
          >
        ...
        <div className="flex flex-col items-center gap-1 text-center">
          <p className="text-xs text-zinc-500">&copy; 2026 Bendito Cross. Todos os direitos reservados.</p>
          <a
