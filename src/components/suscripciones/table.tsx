            ...
            {suscripciones?.map((suscripcion) => (
              ...
              >
                <div className="flex items-center justify-between border-b dark:border-gray-600 pb-4">
                  ...
                  <div className={`px-2 py-1 text-xs rounded-full ${suscripcion.activa ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300'}`}>
